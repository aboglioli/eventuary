...
> **Status:** `0.2.0` stable; `0.3.0-rc.4` pre-release.
...
```toml
[dependencies]
eventuary = { version = "0.3.0-rc.4", features = ["memory"] }
```
...
#    Use tag v0.3.0-rc.4 and title v0.3.0-rc.4.
...
selects `0.3.0-rc.4` — testers must ask for the exact version, and the
